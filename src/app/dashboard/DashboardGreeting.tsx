  ...
  return (
    <div className="relative bg-navy rounded-2xl overflow-hidden">
      ...
      <div className="relative z-10 px-7 py-6 flex items-center justify-between flex-wrap gap-4">
        <div>
          <p className="text-white/50 text-sm font-light tracking-wide mb-1">{greeting}</p>
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl px-5 py-3 border border-white/10">
          <p className="text-white/40 text-[10px] uppercase tracking-widest mb-0.5">Ve firmě</p>
